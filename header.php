...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>ML Research Login</title>

		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta name="description" content="ML Research User Management System">
		<meta name="author" content="ML Research">
	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar">
			<div class="navbar-inner">
				...
				<h3><a class="brand" href="home.php"><?php _e('ML Research'); ?></a></h3>
		...
		<?php if(in_array(1, $_SESSION['jigowatt']['user_level'])) { ?>
					...
					<li><a href="address_listings.php"><i class="icon-edit"></i> <?php _e('Add new address listings'); ?></a></li>
